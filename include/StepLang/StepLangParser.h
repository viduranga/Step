...
class  StepLangParser : public antlr4::Parser {
public:
  enum {
    T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5, T__5 = 6, T__6 = 7, 
    T__7 = 8, T__8 = 9, ACTION = 10, IDENTIFIER = 11, OPERATOR = 12, MUL = 13, 
    DIV = 14, ADD = 15, SUB = 16, NUMBER = 17, WHITESPACE = 18
  };

  enum {
    RuleProgram = 0, RuleMain = 1, RuleFunction = 2, RuleHeader = 3, RuleBody = 4, 
    RuleStatement = 5, RuleVariable_list = 6, RuleInvocation = 7, RuleExpression_list = 8, 
    RuleLoop = 9, RuleExpression = 10
  };

  explicit StepLangParser(antlr4::TokenStream *input);
  ~StepLangParser();
  ...
  public:
    StepLangParser::ExpressionContext *condition = nullptr;
